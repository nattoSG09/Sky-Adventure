...
RotationZComponent::RotationZComponent(StageObject* _holeder, Component* _parent)
	:Component(_holeder, "RotationZComponent", RotationZ,_parent), angle_(0), rotateSpeed_(0)
{
}
